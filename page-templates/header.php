	...
	<div class="gallerycontainer">
 	...
 	<div class="galleryPreviewContainer">
 		...
 		<div class="gallerydescription">
 			<?php 
 			echo '<div class="description1"><div class="desbg"><a href="';echo get_theme_mod('text_description_link1_qwe','');echo '">';echo get_theme_mod('description1_qwe','write your description , please make it just one line');echo '</a></div><a href="';echo get_theme_mod('button_description_link1_qwe','');echo '"><input type="submit" onClick="" name="button1" value="';echo get_theme_mod( 'button1_qwe','button 1' );echo '"/></a></div>';
 			echo '<div class="description2"><div class="desbg"><a href="';echo get_theme_mod('text_description_link2_qwe','');echo '">';echo get_theme_mod('description2_qwe','write your description , please make it just one line');echo '</a></div><a href="';echo get_theme_mod('button_description_link2_qwe','');echo '"><input type="submit" onClick="" name="button2" value="';echo get_theme_mod( 'button2_qwe','button 2' );echo '"/></a></div>';
 			echo '<div class="description3"><div class="desbg"><a href="';echo get_theme_mod('text_description_link3_qwe','');echo '">';echo get_theme_mod('description3_qwe','write your description , please make it just one line');echo '</a></div><a href="';echo get_theme_mod('button_description_link3_qwe','');echo '"><input type="submit" onClick="" name="button3" value="';echo get_theme_mod( 'button3_qwe','button 3' );echo '"/></a></div>';
 			echo '<div class="description4"><div class="desbg"><a href="';echo get_theme_mod('text_description_link4_qwe','');echo '">';echo get_theme_mod('description4_qwe','write your description , please make it just one line');echo '</a></div><a href="';echo get_theme_mod('button_description_link4_qwe','');echo '"><input type="submit" onClick="" name="button4" value="';echo get_theme_mod( 'button4_qwe','button 4' );echo '"/></a></div>';
 			echo '<div class="description5"><div class="desbg"><a href="';echo get_theme_mod('text_description_link5_qwe','');echo '">';echo get_theme_mod('description5_qwe','write your description , please make it just one line');echo '</a></div><a href="';echo get_theme_mod('button_description_link5_qwe','');echo '"><input type="submit" onClick="" name="button5" value="';echo get_theme_mod( 'button5_qwe','button 5' );echo '"/></a></div>';
 			echo '<div class="description6"><div class="desbg"><a href="';echo get_theme_mod('text_description_link6_qwe','');echo '">';echo get_theme_mod('description6_qwe','write your description , please make it just one line');echo '</a></div><a href="';echo get_theme_mod('button_description_link6_qwe','');echo '"><input type="submit" onClick="" name="button6" value="';echo get_theme_mod( 'button6_qwe','button 6' );echo '"/></a></div>';
 			echo '<div class="description7"><div class="desbg"><a href="';echo get_theme_mod('text_description_link7_qwe','');echo '">';echo get_theme_mod('description7_qwe','write your description , please make it just one line');echo '</a></div><a href="';echo get_theme_mod('button_description_link7_qwe','');echo '"><input type="submit" onClick="" name="button7" value="';echo get_theme_mod( 'button7_qwe','button 7' );echo '"/></a></div>';
 			echo '<div class="description8"><div class="desbg"><a href="';echo get_theme_mod('text_description_link8_qwe','');echo '">';echo get_theme_mod('description8_qwe','write your description , please make it just one line');echo '</a></div><a href="';echo get_theme_mod('button_description_link8_qwe','');echo '"><input type="submit" onClick="" name="button8" value="';echo get_theme_mod( 'button8_qwe','button 8' );echo '"/></a></div>';
